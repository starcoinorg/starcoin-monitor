...
pub fn is_current_block_behind(current_block: BlockNumber, cached_block: BlockNumber) -> bool {
...
pub fn should_notify_based_on_time(latest_notify_time: u64, max_interval: u64) -> bool {
...
pub fn check_index_monitor_state(
    ...
    if has_significant_block_difference(current_block, cached_block, config.max_block_difference) {
        ...
        if should_notify_based_on_time(
            ...
            debug!(
                "Significant difference detected but not enough time has passed for notification"
            );
        }
    }
...
mod tests {
    ...
    fn test_has_significant_block_difference() {
        ...
        assert!(has_significant_block_difference(
            1200,
            100,
